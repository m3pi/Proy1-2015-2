...
public class ListAllPozosActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_all_pozos);
...
//                        .setAction("Action", null).show();
                ...
                image.setImageResource(R.drawable.rojo);
            }
        });
    }
    ...
    private List<Pozo> GetPozosFromDB(){
        ...
        Cursor consulta=db.rawQuery("SELECT * FROM Pozos;", null);
